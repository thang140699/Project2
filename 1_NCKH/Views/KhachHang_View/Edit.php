...
if (isset($_SESSION['name']) == true && isset($_SESSION['quyen']) == true && isset($_SESSION['idUser'])) {
	...
	<head>
		...
		<title>TOYOTA (Cập nhật thông tin khách hàng)</title>
		<meta charset="utf-8">
			...
			<center>
				...
				<form action="" method="POST">
					<table border="1">
						...
						if (!empty($data_ID))
						{
							...
							foreach ($data_ID as $value) {
								...
								<tr>
									...
									<td><input type="text" name="tenKH" id="tenKH"></td>
								</tr>
								<tr>
									<td>Số điện thoại</td>
									<td><?php echo $value['sdtKH']; ?></td>
									<td><input type="text" name="sdtKH" id="sdtKH"></td>
								</tr>
						...
						{
							echo "<tr><td></td><td>Không có thông tin</td><td><a href='index.php?controller=KhachHang&action=Add'>Bấm vào đây để thêm</a></td></tr>";
						}
						?>
					</table>
				</form>
		...
		<div class="col-md-2 mx-5">
			<div class="container">
				<div class="row text-center pb-5">
					<ul>
						<li><a href="index.php?controller=KhachHang&action=List&key=">Quay lại danh sách</a></li>
					</ul>         
				</div>
			</div>
		</div>
