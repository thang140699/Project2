...
if (isset($_SESSION['name']) == true && isset($_SESSION['quyen']) == true && isset($_SESSION['idUser'])) {
	...
	<head>
		...
		<title>TOYOTA (Tra cứu thông tin khách hàng)</title>
		<meta charset="utf-8">
						...
						if ( !empty($data_Search)) {
							foreach ($data_Search as $values)
							{
								...
								<tr>
									...
									<td><a href="index.php?controller=KhachHang&action=Edit&idKhachHang=<?php echo $values['idKhachHang']; ?>">Cập nhật thông tin</a></td>
								</tr>
								<?php 
								$stt++;
							}}
				...
				<div class="container">
					<div class="row text-center pb-5">
						<form action="" method="get">
							...
							<input type="text" name="key" placeholder="Nhập bsx, tên, sdt khách hàng">
