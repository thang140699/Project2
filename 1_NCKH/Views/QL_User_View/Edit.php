...
if (isset($_SESSION['name']) == true && isset($_SESSION['quyen']) == true && isset($_SESSION['idUser'])) {
	...
	<head>
		...
		<title>TOYOTA (Cập nhật thông tin account)</title>
		<meta charset="utf-8">
...
<body>
	...
	<div class="row mt-5 mb-5" >
		...
		<div class="col-md-7 boder-right">
			<center>
				<h1>Cập nhật thông tin account</h1>
					...
					<table border="1">
						...
						if (!empty($data_ID))
						{
							...
							foreach ($data_ID as $value) {
								...
								<tr>
									<td>Nhân viên sử dụng account</td>
										...
										<select name="NV_id" id="NV_id">
											...
											foreach ($all as $value) {
												...
												<option value="<?php echo $value['idNhanVien']; ?>">
													...
													echo "Mã nhân viên : ".$value['maNV']." ; Tên nhân viên : ". $value['tenNV']
						...
						{
							echo "<tr><td></td><td>Không có thông tin</td><td><a href='index.php?controller=QL_User&action=Add'>Bấm vào đây để thêm</a></td></tr>";
						}
						?>
					</table>
				</form>
		...
		<div class="col-md-2 mx-5">
			<div class="container">
				<div class="row text-center pb-5">
					<ul>
						<li><a href="index.php?controller=QL_User&action=List&key=">Quay lại danh sách</a></li>
					</ul>         
				</div>
			</div>
		</div>
