...
if (isset($_SESSION['name']) == true && isset($_SESSION['quyen']) == true && isset($_SESSION['idUser'])) {
	...
	<head>
		...
		<title>TOYOTA (Tra cứu thông tin nhân viên)</title>
		<meta charset="utf-8">
						...
						if ( !empty($data_Search)) {
							foreach ($data_Search as $values)
							{
								...
								<tr>
									...
									<td><a href="index.php?controller=NhanVien&action=Edit&idNhanVien=<?php echo $values['idNhanVien']; ?>">Cập nhật thông tin</a></td>
								</tr>
								<?php 
								$stt++;
							}}
				...
				<div class="container">
					<div class="row text-center pb-5">
						<form action="" method="get">
							...
							<input type="text" name="key" placeholder="Nhập mã hoặc tên nhân viên">
