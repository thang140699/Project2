...
if (isset($_SESSION['name']) == true && isset($_SESSION['quyen']) == true && isset($_SESSION['idUser'])) {
	...
	<head>
		...
		<title>TOYOTA (Tra cứu thông tin nguyên vật liệu)</title>
		<meta charset="utf-8">
...
<body>
	...
	<div class="row mt-5 mb-5" >
		...
		<div class="col-md-8 boder-right">
			<center>
				<h3>Bảng thông tin nguyên vật liệu</h3>
				<table border="1">
					<thead>
						<tr>
							<th>STT</th>
						...
						if ( !empty($data_Search)) {
							foreach ($data_Search as $values)
							{
								...
								<tr>
									...
									<td><a href="index.php?controller=NVL&action=Edit&idNVL=<?php echo $values['idNVL']; ?>">Cập nhật thông tin</a></td>
									<td><a href="?controller=Cart&action=Detail&id=<?php echo $values['idNVL']; ?>" target="_blank">Xem chi tiết + Thêm vào ds nhập xuất</a></td>
								</tr>
								<?php 
								$stt++;
							}}
				...
				<div class="container">
					<div class="row text-center pb-5">
						<form action="" method="get">
							<input type="hidden" name="controller" value="NVL">
							<input type="hidden" name="action" value="List">
							<input type="text" name="key" placeholder="Nhập mã hoặc tên NVL">
