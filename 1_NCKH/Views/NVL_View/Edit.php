...
if (isset($_SESSION['name']) == true && isset($_SESSION['quyen']) == true && isset($_SESSION['idUser'])) {
	...
	<head>
		...
		<title>TOYOTA (Cập nhật thông tin nguyên vật liệu)</title>
		<meta charset="utf-8">
...
<script type="text/javascript">
	document.addEventListener('DOMContentLoaded', function()
	{
		...
		document.querySelector('#tenNVL').oninput = function()
		{
			...
			if (tenNVL != "" && vitrikho != "" && donvitinh != "" && soluong != "" && gianhap != "" && giaxuat != "")
			{
...
<body>
	...
	<div class="row mt-5 mb-5" >
		...
		<div class="col-md-7 boder-right">
			<center>
				<h1>Cập nhật thông tin nguyên vật liệu</h1>
				<form action="" method="POST">
					<table border="1">
						...
						if (!empty($data_ID))
						{
							...
							foreach ($data_ID as $value) {
								...
								<tr>
									...
									<td><input type="text" name="tenNVL" id="tenNVL"></td>
								</tr>
								<tr>
									<td>Vị trí kho</td>
									<td><?php echo $value['vitrikho']; ?></td>
									<td><input type="text" name="vitrikho" id="vitrikho"></td>
								</tr>
								<tr>
									<td>Đơn vị tính</td>
								...
								<tr>
									...
									<td><input type="number" name="gianhap" id="gianhap"></td>
								</tr>
								<tr>
									<td>Giá xuất</td>
									<td><?php echo $value['giaxuat']; ?></td>
									<td><input type="number" name="giaxuat" id="giaxuat"></td>
								</tr>
								<tr>
									<td>Ghi chú</td>
								...
								<tr>
									<td>Tên thành phần 1</td>
									<td><?php echo $value['tentp1']; ?></td>
									<td><input type="text" name="tentp1" id="tentp1"></td>
								</tr>
								<tr>
									<td>Khối lượng thành phần 1</td>
									<td><?php echo $value['khoiluongtp1']; ?></td>
									<td><input type="number" name="khoiluongtp1" id="khoiluongtp1"></td>
								</tr>
								<tr>
									<td>Tên thành phần 2</td>
									<td><?php echo $value['tentp2']; ?></td>
									<td><input type="text" name="tentp2" id="tentp2"></td>
								</tr>
								<tr>
									<td>Khối lượng thành phần 2</td>
									<td><?php echo $value['khoiluongtp2']; ?></td>
									<td><input type="number" name="khoiluongtp2" id="khoiluongtp2"></td>
								</tr>
								<tr>
									<td>Tên thành phần 3</td>
									<td><?php echo $value['tentp3']; ?></td>
									<td><input type="text" name="tentp3" id="tentp3"></td>
								</tr>
								<tr>
									<td>Khối lượng thành phần 3</td>
									<td><?php echo $value['khoiluongtp3']; ?></td>
									<td><input type="number" name="khoiluongtp3" id="khoiluongtp3"></td>
								</tr>
								<tr>
									<td>Tên thành phần 4</td>
									<td><?php echo $value['tentp4']; ?></td>
									<td><input type="text" name="tentp4" id="tentp4"></td>
								</tr>
								<tr>
									<td>Khối lượng thành phần 4</td>
									<td><?php echo $value['khoiluongtp4']; ?></td>
									<td><input type="number" name="khoiluongtp4" id="khoiluongtp4"></td>
								</tr>
								<tr>
									<td>Tên thành phần 5</td>
									<td><?php echo $value['tentp5']; ?></td>
									<td><input type="text" name="tentp5" id="tentp5"></td>
								</tr>
								<tr>
									<td>Khối lượng thành phần 5</td>
									<td><?php echo $value['khoiluongtp5']; ?></td>
									<td><input type="number" name="khoiluongtp5" id="khoiluongtp5"></td>
								</tr>
								<?php
							}
							?>
						...
						{
							echo "<tr><td></td><td>Không có thông tin</td><td><a href='index.php?controller=NVL&action=Add'>Bấm vào đây để thêm</a></td></tr>";
						}
						?>
					</table>
				</form>
		...
		<div class="col-md-2 mx-5">
			<div class="container">
				<div class="row text-center pb-5">
					<ul>
						<li><a href="index.php?controller=NVL&action=List&key=">Quay lại danh sách</a></li>
					</ul>         
				</div>
			</div>
		</div>
